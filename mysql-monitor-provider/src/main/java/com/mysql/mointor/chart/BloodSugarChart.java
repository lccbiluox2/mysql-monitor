package com.mysql.mointor.chart;
...
public class BloodSugarChart {
	...
	public DefaultCategoryDataset createDataset() {
		...
		// 曲线名称
		String series = "血糖值a"; // series指的就是报表里的那条数据线  最下面的底部标题
		// 因此 对数据线的相关设置就需要联系到serise
		// 比如说setSeriesPaint 设置数据线的颜色

		// 横轴名称(列名称)
		String[] time = new String[15];
		String[] timeValue = { "6-1日", "6-2日", "6-3日", "6-4日", "6-5日", "6-6日", "6-7日", "6-8日", "6-9日", "6-10日", "6-11日",
				"6-12日", "6-13日", "6-14日", "6-15日" };
		for (int i = 0; i < 15; i++) {
			time[i] = timeValue[i];
		}
		// 随机添加数据值
		...
		linedataset.addValue(100,series,"a1");
		linedataset.addValue(120,series,"a2");
		linedataset.addValue(150,series,"a3");
		linedataset.addValue(50,series,"a4");
		linedataset.addValue(70,series,"a5");
		linedataset.addValue(100,series,"a6");
		linedataset.addValue(160,series,"a7");
		linedataset.addValue(100,series,"a8");
		return linedataset;
	}
